...
<!--//banner-->
		...
		<div class="content-top">
			...
			<h3 id="forms-example" class="text-center">View Marks</h3>
			<form action="{{route('mark.index.search')}}" method="get" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<select name="terminal_id" id="" class="form-control boxe" required> 
